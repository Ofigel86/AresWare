...
unsigned __int64 __cdecl friends_name_hash(unsigned __int8* input_data, unsigned int input_length, unsigned __int64 a3)
{
  ...
  else
  {
    ...
    do
    {
      ...
      v64 ^= v19;
      v66 ^= HIDWORD(v19);
      v20 = sub_10AB8430(__PAIR64__(v76, v82) + __PAIR64__(v15, v16), 0xCB5AF53AE3AAAC31ULL);
      v21 = v78 ^ v20;
      v81 = HIDWORD(v78) ^ HIDWORD(v20);
      v69 = v78 ^ v20;
      v59 = HIDWORD(v78) ^ HIDWORD(v20);
      v22 = sub_10AB8430(v77 + __PAIR64__(v63, v89), 0xC060724A8424F345ULL);
      LODWORD(v79) = v79 ^ v22;
      v58 = v79;
      v78 = v21;
      v7 = v65;
  ...
  default:
    ...
    v25 *= -1677264140;
    v27 = 2617703156LL * v26;
    v70 = (__PAIR64__(-802954325 * v26, 0) + 3492012971LL * (*(_DWORD*)v7 + v60)) >> 32;
    v28 = __CFADD__(__CFADD__(__PAIR64__(-802954325 * v26, 0), 3492012971LL * (*(_DWORD*)v7 + v60)), (_DWORD)v27);
    LODWORD(v27) = v90
      + __CFADD__(__PAIR64__(-802954325 * v26, 0), 3492012971LL * (*(_DWORD*)v7 + v60))
      - 1677264140 * v26;
    HIDWORD(v27) += v28 | __CFADD__(
      v90,
      __CFADD__(__PAIR64__(-802954325 * v26, 0), 3492012971LL * (*(_DWORD*)v7 + v60))
      - 1677264140 * v26);
    v29 = (__PAIR64__(v25, 0) + __PAIR64__(-802954325 * v26, 0) + 3492012971LL * (*(_DWORD*)v7 + v60)) >> 32;
  ...
  LABEL_8:
    ...
    v31 = 3181161666LL * HIDWORD(v30);
    v28 = __CFADD__(__CFADD__(__PAIR64__(745444721 * HIDWORD(v30), 0), 745444721LL * (unsigned int)v30), (_DWORD)v31);
    LODWORD(v31) = v85
      + __CFADD__(
        __PAIR64__(-1113805630 * (int)v30, 0),
        __PAIR64__(745444721 * HIDWORD(v30), 0) + 745444721LL * (unsigned int)v30)
      + v91
      + __CFADD__(__PAIR64__(745444721 * HIDWORD(v30), 0), 745444721LL * (unsigned int)v30)
    ...
    v59 ^= (__PAIR64__(-1113805630 * (int)v30, 0)
      + __PAIR64__(745444721 * HIDWORD(v30), 0)
      + 745444721LL * (unsigned int)v30) >> 32;
    v60 ^= 745444721 * v30;
  ...
  LABEL_9:
    ...
    v33 *= -722440775;
    v35 = 3572526521LL * v34;
    v36 = __CFADD__(__PAIR64__(-1654145461 * v34, 0), 2640821835LL * (*(_DWORD*)v7 + v60));
    v28 = __CFADD__(v36, (_DWORD)v35);
    LODWORD(v35) = v86
      + __CFADD__(
        __PAIR64__(v33, 0),
        __PAIR64__(-1654145461 * v34, 0) + 2640821835LL * (*(_DWORD*)v7 + v60))
      + v92
      + v36
      - 722440775 * v34;
    HIDWORD(v35) += (__CFADD__(
      ...
      v92 + v36 - 722440775 * v34) | __CFADD__(
        ...
        __CFADD__(
          ...
          + 2640821835LL * (*(_DWORD*)v7 + v60))
        + v92
        + v36
        - 722440775 * v34))
      + (v28 | __CFADD__(v92, v36 - 722440775 * v34));
    v58 ^= -1654145461 * (*(_DWORD*)v7 + v60);
    v5 = ((__PAIR64__(v33, 0) + __PAIR64__(-1654145461 * v34, 0) + 2640821835LL * (*(_DWORD*)v7 + v60)) >> 32) ^ v62;
  ...
  LABEL_21:
    ...
    v48 = sub_10AB8430(v47 + __PAIR64__(v5, v58), 0xEC99BF0D8372CAABULL);
    v49 = __PAIR64__(v5, v58) >> 23;
    HIDWORD(v57) = (__PAIR64__(v58, v5) >> 23) + __CFADD__(v49, v60) + v59;
    LODWORD(v57) = v49 + v60;
    v50 = sub_10AB8430(v57, 0xCB5AF53AE3AAAC31ULL);
    ...
    v54 = 3227546186LL * (unsigned int)(HIDWORD(v48) ^ HIDWORD(v50));
