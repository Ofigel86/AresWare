...
#define CLASSNAME BasePlayer
	...
	public:
		...
		{
			// FIX: was a() < 255 - that skipped players with ANY transparency
			// (custom server skins, low-alpha renders). Real spawn protection
			// uses strong alpha (~120), so only strong transparency is skipped.
			return ( this->m_clrRender( ).a( ) < 200 );
		}
		...
		*/
		...
		inline Vector EyePosition( ) // r47: return by value (the old Vector& bound to a temporary = UB)
		{
