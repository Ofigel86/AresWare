...
#include <stdio.h> // r47: was <fstream> (libstdc++ lazy filebuf instantiation breaks under mingw min/max macros)
...
public: 
	//Constructor 
	CDoubleBuffering(FILE* in, char* pcBuff, int iSize, int iDataLen); // r47: was ifstream&
	//Get Next Data Buffer 
	int GetData(char* pszDataBuf, int iDataLen=-1); 
 
private: 
	FILE* m_rin; // r47: was ifstream&
	int m_iSize; 
