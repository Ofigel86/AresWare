...
extern Vector					g_vecOrigin[ 65 ][ MULTIPLAYER_BACKUP ]; // r37
...
extern bool						g_DTAttack;
extern int						g_DTCharge;
extern bool						g_DTInBurst;
extern int						g_DTForceLeft;
extern int						g_DTForceIdx;
extern QAngle						g_DTAimAngles;
extern int						g_DTTick;
extern int						g_DTTicks;

extern int						g_Tick;
extern int						g_iGameTicks;
extern int						g_iBulletsFired[ 65 ]; // r37: indexed by TargetIndex 1..64
extern float					g_flSimulationTime[ 65 ]; // r37
extern float					g_flAnimTime[ 65 ]; // r37
