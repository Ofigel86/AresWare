...
void CConfig::Load( void )
{
	...
	g_CVars.Miscellaneous.AntiAim.AASpinSpeed = GetPrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AASpinSpeed", 20.f, path.c_str( ) );
	...
	g_CVars.Miscellaneous.AntiAim.Conditions[ 0 ].PitchMode = GetPrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAStandPitchMode", 3, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 0 ].PitchCustom = GetPrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAStandPitchCustom", 89.f, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 0 ].RealYawMode = GetPrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAStandRealYawMode", 2, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 0 ].FakeYawMode = GetPrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAStandFakeYawMode", 6, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 0 ].RealCustom = GetPrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAStandRealCustom", 180.f, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 0 ].FakeCustom = GetPrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAStandFakeCustom", 180.f, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 0 ].JitterAmount = GetPrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAStandJitterAmount", 45.f, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 0 ].JitterInterval = GetPrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAStandJitterInterval", 2, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 1 ].PitchMode = GetPrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAAirPitchMode", 3, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 1 ].PitchCustom = GetPrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAAirPitchCustom", 89.f, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 1 ].RealYawMode = GetPrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAAirRealYawMode", 2, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 1 ].FakeYawMode = GetPrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAAirFakeYawMode", 6, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 1 ].RealCustom = GetPrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAAirRealCustom", 180.f, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 1 ].FakeCustom = GetPrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAAirFakeCustom", 180.f, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 1 ].JitterAmount = GetPrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAAirJitterAmount", 45.f, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 1 ].JitterInterval = GetPrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAAirJitterInterval", 2, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 2 ].PitchMode = GetPrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AACrouchPitchMode", 3, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 2 ].PitchCustom = GetPrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AACrouchPitchCustom", 89.f, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 2 ].RealYawMode = GetPrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AACrouchRealYawMode", 2, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 2 ].FakeYawMode = GetPrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AACrouchFakeYawMode", 6, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 2 ].RealCustom = GetPrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AACrouchRealCustom", 180.f, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 2 ].FakeCustom = GetPrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AACrouchFakeCustom", 180.f, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 2 ].JitterAmount = GetPrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AACrouchJitterAmount", 45.f, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 2 ].JitterInterval = GetPrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AACrouchJitterInterval", 2, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 3 ].PitchMode = GetPrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AASlowWalkPitchMode", 3, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 3 ].PitchCustom = GetPrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AASlowWalkPitchCustom", 89.f, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 3 ].RealYawMode = GetPrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AASlowWalkRealYawMode", 2, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 3 ].FakeYawMode = GetPrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AASlowWalkFakeYawMode", 6, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 3 ].RealCustom = GetPrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AASlowWalkRealCustom", 180.f, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 3 ].FakeCustom = GetPrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AASlowWalkFakeCustom", 180.f, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 3 ].JitterAmount = GetPrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AASlowWalkJitterAmount", 45.f, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 3 ].JitterInterval = GetPrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AASlowWalkJitterInterval", 2, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 4 ].PitchMode = GetPrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAMovePitchMode", 3, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 4 ].PitchCustom = GetPrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAMovePitchCustom", 89.f, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 4 ].RealYawMode = GetPrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAMoveRealYawMode", 2, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 4 ].FakeYawMode = GetPrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAMoveFakeYawMode", 6, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 4 ].RealCustom = GetPrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAMoveRealCustom", 180.f, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 4 ].FakeCustom = GetPrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAMoveFakeCustom", 180.f, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 4 ].JitterAmount = GetPrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAMoveJitterAmount", 45.f, path.c_str( ) );
	g_CVars.Miscellaneous.AntiAim.Conditions[ 4 ].JitterInterval = GetPrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAMoveJitterInterval", 2, path.c_str( ) );	g_CVars.Miscellaneous.Fakelag.Active = GetPrivateProfileInteger( /*Fakelag*/XorStr<0x0D,8,0xB5531447>("\x4B\x6F\x64\x75\x7D\x73\x74"+0xB5531447).s, /*Active*/XorStr<0x05,7,0x27ACD844>("\x44\x65\x73\x61\x7F\x6F"+0x27ACD844).s, 0, path.c_str( ) );
...
void CConfig::Save( void )
{
	...
	WritePrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AASpinSpeed", g_CVars.Miscellaneous.AntiAim.AASpinSpeed, path.c_str( ) );
	...
	WritePrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAStandPitchMode", g_CVars.Miscellaneous.AntiAim.Conditions[ 0 ].PitchMode, path.c_str( ) );
	WritePrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAStandPitchCustom", g_CVars.Miscellaneous.AntiAim.Conditions[ 0 ].PitchCustom, path.c_str( ) );
	WritePrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAStandRealYawMode", g_CVars.Miscellaneous.AntiAim.Conditions[ 0 ].RealYawMode, path.c_str( ) );
	WritePrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAStandFakeYawMode", g_CVars.Miscellaneous.AntiAim.Conditions[ 0 ].FakeYawMode, path.c_str( ) );
	WritePrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAStandRealCustom", g_CVars.Miscellaneous.AntiAim.Conditions[ 0 ].RealCustom, path.c_str( ) );
	WritePrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAStandFakeCustom", g_CVars.Miscellaneous.AntiAim.Conditions[ 0 ].FakeCustom, path.c_str( ) );
	WritePrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAStandJitterAmount", g_CVars.Miscellaneous.AntiAim.Conditions[ 0 ].JitterAmount, path.c_str( ) );
	WritePrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAStandJitterInterval", g_CVars.Miscellaneous.AntiAim.Conditions[ 0 ].JitterInterval, path.c_str( ) );
	WritePrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAAirPitchMode", g_CVars.Miscellaneous.AntiAim.Conditions[ 1 ].PitchMode, path.c_str( ) );
	WritePrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAAirPitchCustom", g_CVars.Miscellaneous.AntiAim.Conditions[ 1 ].PitchCustom, path.c_str( ) );
	WritePrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAAirRealYawMode", g_CVars.Miscellaneous.AntiAim.Conditions[ 1 ].RealYawMode, path.c_str( ) );
	WritePrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAAirFakeYawMode", g_CVars.Miscellaneous.AntiAim.Conditions[ 1 ].FakeYawMode, path.c_str( ) );
	WritePrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAAirRealCustom", g_CVars.Miscellaneous.AntiAim.Conditions[ 1 ].RealCustom, path.c_str( ) );
	WritePrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAAirFakeCustom", g_CVars.Miscellaneous.AntiAim.Conditions[ 1 ].FakeCustom, path.c_str( ) );
	WritePrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAAirJitterAmount", g_CVars.Miscellaneous.AntiAim.Conditions[ 1 ].JitterAmount, path.c_str( ) );
	WritePrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAAirJitterInterval", g_CVars.Miscellaneous.AntiAim.Conditions[ 1 ].JitterInterval, path.c_str( ) );
	WritePrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AACrouchPitchMode", g_CVars.Miscellaneous.AntiAim.Conditions[ 2 ].PitchMode, path.c_str( ) );
	WritePrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AACrouchPitchCustom", g_CVars.Miscellaneous.AntiAim.Conditions[ 2 ].PitchCustom, path.c_str( ) );
	WritePrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AACrouchRealYawMode", g_CVars.Miscellaneous.AntiAim.Conditions[ 2 ].RealYawMode, path.c_str( ) );
	WritePrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AACrouchFakeYawMode", g_CVars.Miscellaneous.AntiAim.Conditions[ 2 ].FakeYawMode, path.c_str( ) );
	WritePrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AACrouchRealCustom", g_CVars.Miscellaneous.AntiAim.Conditions[ 2 ].RealCustom, path.c_str( ) );
	WritePrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AACrouchFakeCustom", g_CVars.Miscellaneous.AntiAim.Conditions[ 2 ].FakeCustom, path.c_str( ) );
	WritePrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AACrouchJitterAmount", g_CVars.Miscellaneous.AntiAim.Conditions[ 2 ].JitterAmount, path.c_str( ) );
	WritePrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AACrouchJitterInterval", g_CVars.Miscellaneous.AntiAim.Conditions[ 2 ].JitterInterval, path.c_str( ) );
	WritePrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AASlowWalkPitchMode", g_CVars.Miscellaneous.AntiAim.Conditions[ 3 ].PitchMode, path.c_str( ) );
	WritePrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AASlowWalkPitchCustom", g_CVars.Miscellaneous.AntiAim.Conditions[ 3 ].PitchCustom, path.c_str( ) );
	WritePrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AASlowWalkRealYawMode", g_CVars.Miscellaneous.AntiAim.Conditions[ 3 ].RealYawMode, path.c_str( ) );
	WritePrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AASlowWalkFakeYawMode", g_CVars.Miscellaneous.AntiAim.Conditions[ 3 ].FakeYawMode, path.c_str( ) );
	WritePrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AASlowWalkRealCustom", g_CVars.Miscellaneous.AntiAim.Conditions[ 3 ].RealCustom, path.c_str( ) );
	WritePrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AASlowWalkFakeCustom", g_CVars.Miscellaneous.AntiAim.Conditions[ 3 ].FakeCustom, path.c_str( ) );
	WritePrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AASlowWalkJitterAmount", g_CVars.Miscellaneous.AntiAim.Conditions[ 3 ].JitterAmount, path.c_str( ) );
	WritePrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AASlowWalkJitterInterval", g_CVars.Miscellaneous.AntiAim.Conditions[ 3 ].JitterInterval, path.c_str( ) );
	WritePrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAMovePitchMode", g_CVars.Miscellaneous.AntiAim.Conditions[ 4 ].PitchMode, path.c_str( ) );
	WritePrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAMovePitchCustom", g_CVars.Miscellaneous.AntiAim.Conditions[ 4 ].PitchCustom, path.c_str( ) );
	WritePrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAMoveRealYawMode", g_CVars.Miscellaneous.AntiAim.Conditions[ 4 ].RealYawMode, path.c_str( ) );
	WritePrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAMoveFakeYawMode", g_CVars.Miscellaneous.AntiAim.Conditions[ 4 ].FakeYawMode, path.c_str( ) );
	WritePrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAMoveRealCustom", g_CVars.Miscellaneous.AntiAim.Conditions[ 4 ].RealCustom, path.c_str( ) );
	WritePrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAMoveFakeCustom", g_CVars.Miscellaneous.AntiAim.Conditions[ 4 ].FakeCustom, path.c_str( ) );
	WritePrivateProfileFloat( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAMoveJitterAmount", g_CVars.Miscellaneous.AntiAim.Conditions[ 4 ].JitterAmount, path.c_str( ) );
	WritePrivateProfileInteger( /*AntiAim*/XorStr<0x67,8,0x84564416>("\x26\x06\x1D\x03\x2A\x05\x00"+0x84564416).s, "AAMoveJitterInterval", g_CVars.Miscellaneous.AntiAim.Conditions[ 4 ].JitterInterval, path.c_str( ) );	WritePrivateProfileInteger( /*Fakelag*/XorStr<0x0D,8,0xB5531447>("\x4B\x6F\x64\x75\x7D\x73\x74"+0xB5531447).s, /*Active*/XorStr<0x05,7,0x27ACD844>("\x44\x65\x73\x61\x7F\x6F"+0x27ACD844).s, g_CVars.Miscellaneous.Fakelag.Active, path.c_str( ) );
